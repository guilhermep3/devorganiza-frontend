...
export const ServicesCard = ({ data, Icon }: props) => {
  ...
  return (
    ...
    >
      <div className="group flex flex-col gap-3 p-6 rounded-lg transition border border-gray-10 hover:border-gray-20
        hover:shadow-md hover:shadow-gray-30 dark:hover:shadow-gray-10"
      >
